...
def central_corridor():
    ...
    action=raw_input("> ")
    if action=="shoot!":
        print "Quick on the draw you yank out your blaster and fire it athe Gothon"
        print "His clown costume is flowing and moving around his body,which throws"
        print "off your aim.Your laser hits his costume but misses him entriely.This"
        ...
        print "Lucky for you they made you leran Gothon insults in the academy"
        print "You tell the one Gothon joke you konw:"
        print "Lbhe zbdsfga sdf df aaetg gij,gjad dgkadf dllda  df."
...
def laser_weapon_armory():
    ...
    if guess==code:
        ...
        print "Your grab the neutron bomb and run as fast as you can to the "
        print "bridge where you must place it in the right spot"
        return 'the_bridge'
    else:
        print "The lock buzzes one last time and then you hear a sickening"
        print "melting sound as the mechainsm is fused together"
        print "Your decide to sit there,and finally the Gothons blow up the "
